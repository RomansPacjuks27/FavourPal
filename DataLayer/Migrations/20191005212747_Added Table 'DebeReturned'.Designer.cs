...
namespace DataLayer.Migrations
{
    ...
    [Migration("20191005212747_Added Table 'DebeReturned'")]
    partial class AddedTableDebeReturned
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataLayer.Models.DebtReturned", b =>
                {
                    b.HasOne("DataLayer.Models.Users", "FK_userFrom")
                        .WithMany()
                        .HasForeignKey("ReturnFromUser");

                    b.HasOne("DataLayer.Models.Users", "FK_userTo")
                        .WithMany()
